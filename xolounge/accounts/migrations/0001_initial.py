    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Может заходить в админ-панель', verbose_name='Персонал')),
                ('is_active', models.BooleanField(default=True, help_text='Считается активным, если галочка стоит', verbose_name='Активен')),
